...
[
  {
    ...
    "slug": "kuangren-riji",
    "title": "狂人日记",
    "summary": "作品借“狂人”的日记与独特视角，揭示传统社会中压迫个体的伦理秩序，并发出“救救孩子”的呼声。",
    "body": "《狂人日记》采用日记体形式展开叙述。主人公从周围人的目光、言语和历史记载中感受到“吃人”的威胁。作品中的“吃人”不仅指向身体层面的恐惧，也成为封建礼教和社会压迫的象征。作品通过不可靠叙述、心理描写和象征手法，表现个体觉醒后的孤独与抗争。",
    "image_path": null,
    "metadata": {
      "year": "1918",
      "genre": "短篇小说",
      "collection": "《呐喊》",
      "first_published": "《新青年》第四卷第五号",
      "keywords": [
        "吃人",
        "礼教",
        "觉醒",
